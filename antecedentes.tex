...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.2\textwidth]{./img/cordova.jpg}
...
\begin{itemize}
	...
	\item Al estar escrita en Javascript, se puede utilizar en el poyecto gran parte de los modulos disponibles a traves 
