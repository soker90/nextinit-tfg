...
\begin{acronym}[XXXXXXXX]
	...
	\acro{ADFS} {Active Directory Federation Services}
	\acro{ESI}{Escuela Superior de Informática}
	\acro{FORTE}{FORTalecimiento de las competencias profesionales de los graduados para la mejora de su Empleabilidad}
\end{acronym}
}
