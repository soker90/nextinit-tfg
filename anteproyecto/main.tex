...
\begin{document}
    ...
    Las ideas se crean dentro de la plataforma como si fueran startups que necesitan dinero para empezar. Los usuarios,
    además de poder crear ideas, pueden invertir dinero virtual en ellas y aumentar así el capital de la idea para que
    esta puede llevarse a cabo. Cuando una idea recibe mucha inversión por parte del resto de usuarios significa que 
    las personas de esa organización creen que es una buena idea.
    ...
    abandonadas, son poco robustas y el coste de realizar cambios es elevado.
    ...
    El objetivo principal de este TFG es la creación de una aplicación para móviles que permita utilizar la plataforma 
    Nextinit anteriormente descrita, desarrollada con tecnologías híbridas y que con un único 
    desarrollo, funcione en IOS y Android, adaptándose de forma adecuada a cada sistema operativo. La 
