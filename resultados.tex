...
usuarios en el servidor de autenticación de los empleados de Viesgo que funcionaba con (Microsoft...).

Al final del sprint no se hizo y se hizo el de multidominio
