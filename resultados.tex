...
Además se realizó las pantallas de crear nuevas ideas, algunas de las secciones son opcionales y solo se mostraran si están activadas en 
el nextinit, además algunos elementos como los objetivos son los introducidos por la organización. Para crear la idea es necesario seleccionar 
una imagen de la idea, que puede ser seleccionada desde la galería o realizada con la cámara del dispositivo.

\subsection{Sprint 4}

Terminar crear ide y editar idea se le añaden los dessafios a la pagina de inicio
